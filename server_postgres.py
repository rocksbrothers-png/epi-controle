        ...
        try:
            ...
            if purchase_request_match:
                with closing(get_connection()) as connection:
                    ...
                    ensure_purchase_request_action_scope(connection, actor, row_to_dict(pr), actor_operational_unit_id=actor_operational_unit_id)
                    items = connection.execute(
    ...
    def do_POST(self):
        ...
        try:
            ...
            with closing(get_connection()) as connection:
                ...
                elif parsed.path == '/api/avaliacoes/pre-evaluate':
                    require_fields(payload, ['actor_user_id', 'feedback_id'])
                    actor = authorize_action(connection, resolve_actor_user_id(self, parsed, payload), PERM_EPI_EVALUATION_DECIDE)
                ...
                # ── Fase 2 — Compras POST ──────────────────────────────────────
                    ...
                    if pr_id:
                        ...
                        ensure_purchase_request_action_scope(connection, actor, row_to_dict(pr_scope), actor_operational_unit_id=actor_operational_unit_id)
